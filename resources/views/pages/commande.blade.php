        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <ul class="grid grid-cols-3 mt-4 gap-x-5 m-10 max-w-md mx-auto">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value="colis" name="type_prod" id="answer_no">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value="fragile" name="type_prod" id="answer_maybe">
            ...
            <span class="text-gray-700 dark:text-gray-400 font-bold">Température</span>
            <ul class="grid grid-cols-3 mt-4 gap-x-5 m-10 max-w-md mx-auto">
              <li class="relative font-blod">
                <input class="sr-only peer" type="radio" value="chaud" name="temperature" id="answer_y">
                <label class="flex items-center justify-center font-blod p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none peer-checked:bg-red-500 peer-checked:text-white  peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent " for="answer_y">Chaud</label>
            
                
            
              <li class="relative">
                <input class="sr-only peer" type="radio" value="froid" name="temperature" id="answer_">
                <label class="flex items-center justify-center p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none  peer-checked:ring-red-500 peer-checked:bg-red-500 peer-checked:text-white peer-checked:ring-2 peer-checked:border-transparent" for="answer_">Froid</label>
            
                
               </li>
            
              <li class="relative">
                <input class="sr-only peer" type="radio" value="ambiant" name="temperature" id="answer_may">
                <label class="flex items-center justify-center p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none peer-checked:bg-red-500 peer-checked:text-white peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" for="answer_may"> Ambiant</label>
            
                
              </li>
            </ul>
            <span class="text-gray-700 dark:text-gray-400 font-bold">Taille du colis</span>
            <ul class="grid grid-cols-3 mt-4 gap-x-5 m-10 max-w-md mx-auto">
              <li class="relative font-blod">
                <input class="sr-only peer" type="radio" value="courses" name="taille" id="answer_ye">
                <label class="flex items-center justify-center font-blod p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none peer-checked:bg-red-500 peer-checked:text-white  peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent " for="answer_ye">Volimineux</label>
            
                
            
              <li class="relative">
                <input class="sr-only peer" type="radio" value="colis" name="taille" id="answer_n">
                <label class="flex items-center justify-center p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none  peer-checked:ring-red-500 peer-checked:bg-red-500 peer-checked:text-white peer-checked:ring-2 peer-checked:border-transparent" for="answer_n"> Moyen</label>
            
                
               </li>
            
              <li class="relative">
                <input class="sr-only peer" type="radio" value="maybe" name="taille" id="answer_mayb">
                <label class="flex items-center justify-center p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none peer-checked:bg-red-500 peer-checked:text-white peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" for="answer_mayb"> Petit</label>
            ...
            <ul class="grid grid-cols-3 mt-4 gap-x-5 m-10 max-w-md mx-auto">
              <li class="relative">
                <input class="sr-only peer" type="radio" value="<3" name="poids" id="answer_yess">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value="3-10" name="poids" id="answer_nos">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value=">10" name="poids" id="answer_maybes">
            ...
            <ul class="grid grid-cols-3 mt-4 gap-x-5 m-10 max-w-md mx-auto">
              <li class="relative">
                <input class="sr-only peer" type="radio" value="<5" name="nombre_colis" id="answer_yesss">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value="5-10" name="nombre_colis" id="answer_noss">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value=">10" name="nombre_colis" id="answer_maybess">
            ...
            <ul class="grid grid-cols-3 mt-4 gap-x-5 m-10 max-w-md mx-auto">
              <li class="relative">
                <input class="sr-only peer" type="radio" value="Piéton" name="nombre_coliss" id="answer_yessss">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value="Vélo" name="nombre_coliss" id="answer_nossss">
              ...
              <li class="relative">
                <input class="sr-only peer" type="radio" value="Scooter" name="nombre_coliss" id="answer_maybesss">
              ...
              <li class="relative mt-4">
                <input class="sr-only peer" type="radio" value="Camion" name="nombre_coliss" id="answer_maybesssss" required>
              ...
              <li class="relative mt-4">
                <input class="sr-only peer" type="radio" value="Voiture" name="nombre_coliss" id="answer_maybessss">
            ...
            <span class="text-gray-700 dark:text-gray-400 font-bold">Monter à l'étage</span>
            <ul class="grid grid-cols-3 mt-4 gap-x-5 m-10 max-w-md mx-auto">
              <li class="relative font-blod">
                <input class="sr-only peer" type="radio" value="oui" name="etage" id="aswer_y">
                <label class="flex items-center justify-center font-blod p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none peer-checked:bg-red-500 peer-checked:text-white  peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent " for="aswer_y">Oui</label>
            
                
            
              <li class="relative">
                <input class="sr-only peer" type="radio" value="non" name="etage" id="answe">
                <label class="flex items-center justify-center p-5  bg-white border border-gray-300 text-sm rounded-lg cursor-pointer focus:outline-none  peer-checked:ring-red-500 peer-checked:bg-red-500 peer-checked:text-white peer-checked:ring-2 peer-checked:border-transparent" for="answe"> Non</label>
            ...
            {{-- <div class="flex">
              ...
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400 font-bold">Date de collecte</span>
              ...
              <label class="block mt-4 text-sm">
                ...
                <input Type="time" name="heure"
                  class="block relative left-5 p-2  mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input" required
                />
            ...
            <div class="border border-red-300 border-t-transparent p-4"> --}}
              ...
              {{-- <div class="flex">
                ...
                <label class="block mt-4 text-sm">
                  ...
                  <input Type="text" name="date_depot" id="datepickers" placeholder="Date"
                    class="block  mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input" required
                  />
                ...
                <label class="block mt-4 text-sm">
                  <span class="text-gray-700 relative left-5 dark:text-gray-400 font-bold">Heure</span>
                  <input Type="time" name="heuredepot"
                    class="block relative left-5 p-2  mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input" required
                  />
